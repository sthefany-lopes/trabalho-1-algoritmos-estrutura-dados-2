...
#define TAMANHO_BLOCO_INDICE 5000
...
// Configurações de tabela hash.
#define TAM_HASH 2503

// Configurações de árvore B.
#define ORDEM_ARVORE_B 100
...
#define TAM_PAGINA_BUCKETS 50

// Configurações de reorganização de arquivos.
